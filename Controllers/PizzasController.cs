...
namespace PizzaOrderSystem2.Controllers
{
    public class PizzasController : Controller
    {
        ...
        public PizzasController(PizzaOrderSystem2Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Pizza != null ? 
                          ...
                          Problem("Entity set 'PizzaOrderSystem2Context.Pizza'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("PizzaID,Name,Type,Speciality,Crust,Price,Size")] Pizza pizza)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PizzaID,Name,Type,Speciality,Crust,Price,Size")] Pizza pizza)
        {
            if (id != pizza.PizzaID)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'PizzaOrderSystem2Context.Pizza'  is null.");
            }
            var pizza = await _context.Pizza.FindAsync(id);
            if (pizza != null)
            {
